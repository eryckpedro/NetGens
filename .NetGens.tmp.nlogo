...
O NetGens foi desenvolvido por Eryck Pedro da Silva como Trabalho Final da disciplina de Introdução à Informática e Educação do Programa de Pós-Graduação em Informática da Universidade Federal do Rio de Janeiro, sob orientação do professor Fábio Fer
